                                        ...
                                        <div className="popup-container">
                                            <a href="#!">
                                                <span>지금 가입하고 인기상품 100원에 받아가세요!
                                                    <i>
                                                        <img src="./images/ico_arrow_fff_84x84.webp" alt="arrow" />
                                                    </i>
                                                </span>
                                            </a>
                                            <span>
                                                <button onClick={onClickPopupClose} className="popup-close-btn" title="닫기">
                                                    <img src="./images/ico_close_fff_42x42.png" alt="close" />
                                                </button>
                                            </span>
                                        </div>
                                    </div>
                        ...
                        <div className="content">
                            <form name='login_form' id='loginForm' method='post' autoComplete='off'>
                                <ul>
                                    ...
                                    <li>
                                        <button onClick={onClickLoginEvent} class='login-btn' type='button'>로그인</button>
                                    </li>
                                    <li>
                                        <button onClick={onClickGaibEvent} class='gaib-btn' type='button'>회원가입</button>
                                    </li>
                                </ul>
                            </form>
                        </div>
                ...
                if(아이디==='' || 비밀번호==='' || 비밀번호확인==='' || 이름==='' || 이메일==='' || 휴대폰==='' || 주소1==='' || 주소2==='' || 아이디중복확인Ok===false || 이메일중복확인Ok===false || 휴대폰인증확인Ok===false){
                    ...
                    if(cnt<3){
                        ...
                        const axiosFn=()=>{
                            ...
                            .then((response)=>{
                                modalOpenFn('AXIOS 성공 마켓컬리 회원가입을 진심으로 감사드립니다')
                                setField({
                                    ...field,
